...
RTL8812EU is new, cheap, widely used WiFi chip. Wich can be found on wide variety of WiFi adapters.
...
## BL-M8812EU2
LB-LINK BL-M8812EU2 is cheap, powerful WiFi adapter, wich can be found on [Runcam WiFiLink 1](/hardware/runcam/vtx/runcam-wifilink-v1/).
### Layout
Top view
![image](/src/assets/images/bl-m8812eu2-top.png)

Bottom view(with pins numbers)
<ThemeImage
